...
@protocol GTMOAuth2ViewControllerTouchDelegate;
...
@property (nonatomic, assign) id<GTMOAuth2ViewControllerTouchDelegate> delegate;
...
@protocol GTMOAuth2ViewControllerTouchDelegate <NSObject>
