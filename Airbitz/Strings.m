...
#define scanQrToSendFundsText                       NSLocalizedString(@"Scan to Send, Import, or Edge Login", @"Text at top of Send screen")
...
#define incorrectPasswordTryAgainChangeText         NSLocalizedString(@"Incorrect Password. Try again, or change it now?", nil)
#define incorrectPasswordTryAgainText               NSLocalizedString(@"Incorrect Password. Try again?", nil)
...
#define no_pin_set_text                             NSLocalizedString(@"No PIN set", nil)
...
#define recoveryAnswersCorrupt                      NSLocalizedString(@"Your account recovery answers are corrupt. You will not be able to recover your account if your password is forgotten. Please login as %@ and re-setup password recovery. For details, please see our blog post at airbitz.co/go" ,nil)
...
#define default_fork_text                           NSLocalizedString(@"Default: Highest value pre-fork", @"settings text")
#define bitcoin_core_text                           NSLocalizedString(@"Bitcoin Core", @"settings text")
#define bitcoin_2x_text                             NSLocalizedString(@"Bitcoin 2x", @"settings text")
...
#define choose_bitcoin_fork                         NSLocalizedString(@"Choose Bitcoin Fork",nil)
...
#define buy_sell_bank_eur_chf                       NSLocalizedString(@"Buy/Sell with Bank Account (EUR/CHF)", nil)
