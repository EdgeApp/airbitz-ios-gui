...
#define youMustAnswerAllSix                         NSLocalizedString(@"You must answer all six questions. Make sure your answers are long enough." ,nil)
#define youMustChooseAllSix                         NSLocalizedString(@"You must choose all six questions before proceeding." ,nil)
