...
{	
    ...
    self.cachedUsername = [defaults stringForKey:KEY_LOCAL_SETTINGS_CACHED_USERNAME];
...
- (void)saveAll
{
    ...
    [defaults setValue:     [self cachedUsername] forKey:KEY_LOCAL_SETTINGS_CACHED_USERNAME];
